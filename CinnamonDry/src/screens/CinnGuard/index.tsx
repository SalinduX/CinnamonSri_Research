...
const FEATURES = [
  { icon: "🛡️", title: "Pest Detection",       desc: "Camera-based pest and disease identification"  },
  { icon: "🚨", title: "Alert System",          desc: "Real-time alerts for threats and anomalies"    },
  { icon: "📊", title: "Health Reports",        desc: "Plantation health scores and recommendations"  },
  { icon: "💊", title: "Treatment Advisor",     desc: "AI-suggested treatments and interventions"     },
];

export default function CinnGuard() {
  return (
    <ScrollView style={styles.scroll}>
      {/* Hero */}
      <View style={styles.hero}>
        <Text style={styles.heroIcon}>🛡️</Text>
        <Text style={styles.heroTitle}>CinnGuard</Text>
        <Text style={styles.heroSub}>Plantation Protection System</Text>
      ...
      <View style={styles.devNote}>
        ...
        <Text style={styles.devNoteText}>
          ...
          <Text style={styles.devNotePath}>src/screens/CinnGuard/</Text>
...
const styles = StyleSheet.create({
  ...
  comingSoon:       { marginTop: 16, borderWidth: 1, borderColor: C.red, borderRadius: 99, paddingVertical: 6, paddingHorizontal: 20, backgroundColor: C.redDim },
  comingSoonText:   { color: C.red, fontSize: 11, fontWeight: "700", fontFamily: FONTS.mono, letterSpacing: 3 },
